...
const MARKER_ADJUSTMENTS = {
    "woods":              { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "customs":            { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "factory":            { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "shoreline":          { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "reserve":            { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "interchange":        { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "the-lab":            { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "ground-zero":        { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "the-labyrinth":      { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "lighthouse":         { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "streets-of-tarkov":  { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "terminal":           { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    "icebreaker":         { tx: 0, ty: 0, scale: 1.0, rot: 0 },
    // 变体地图复用主地图的数据
...
```javascript
// 获取该地图的调整参数
const adj = MARKER_ADJUSTMENTS[normalizedName] || { tx:0, ty:0, scale:1, rot:0 };
...
// 先缩放 & 旋转（以原点为中心）
const scaled_rx = rx * adj.scale;
const scaled_rz = rz * adj.scale;
